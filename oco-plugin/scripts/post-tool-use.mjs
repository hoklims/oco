...
// DEPRECATED: This command hook is a fallback for when `oco serve` is not running.
// The primary PostToolUse handler is now an HTTP hook → POST /api/v1/hooks/post-tool.
// This file will be removed in v0.15.0. See issue #96.
//
